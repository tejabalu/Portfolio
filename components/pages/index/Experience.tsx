      ...
      <List spacing={18} fontSize="18">
        <ListItem display="flex">
          ...
          <Box>
            ...
            <Paragraph fontSize="lg" pl={3}>
              <Divider pt="2" borderColor={"transparent"} />
              Responsible for identifying and developing industrial software
              applications (Manufacturing Execution Systems) for Industry 4.0
              projects focused on warehosue applications across all Saint-Gobain
